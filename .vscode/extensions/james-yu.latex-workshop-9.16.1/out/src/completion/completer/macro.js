...
function initialize() {
    ...
    const defaultEnvs = environment_1.environment.getDefaultEnvs(types_1.EnvSnippetType.AsCommand);
...
function provide(langId, line, position) {
    ...
    if ((configuration.get('intellisense.package.enabled'))) {
        ...
        Object.entries(packages).forEach(([packageName, options]) => {
            ...
            environment_1.environment.provideEnvsAsCommandInPkg(packageName, options, suggestions, defined);
        });
    }
